...
#### 📊 MUN104数据集集成与扫描线对齐
<div align="center">
<img src="result/scanline_alignment.png" width="600" alt="扫描线对齐分析可视化">
</div>

*基于MUN104项目104人足底压力数据的扫描线对齐算法可视化结果。该图展示了8条水平扫描线(位于足部高度8%和90%位置)如何将标准化压力分布精确映射到个人足部形状上，实现压力热图与足部轮廓的完美贴合。*
